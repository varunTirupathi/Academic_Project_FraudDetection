...
def stopStartStreamingJob():
    ...
    start_streaming = 'spark-submit --class com.project.spark.jobs.RealTimeFraudDection --name "RealTime Creditcard FraudDetection" --master spark://project:7077' + ' '  + '--deploy-mode cluster' + ' ' + home + '/frauddetection/spark/fruaddetection-spark.jar' + ' ' + home + '/frauddetection/spark/application-local.conf &'
